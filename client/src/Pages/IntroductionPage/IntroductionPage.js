...
import Meeting from '../../resources/images/meeting.jpg'
const IntroductionPage = (props) => {
  ...
  return (
    <Box overflow='scroll'>
      <Box className='homePageMainContainer' sx={{ display: 'grid', gridTemplateColumns: '55% 45%', padding: '0px 20px', mt: '5%', alignItems: 'center' }}>
        <Box justifyContent='center' padding='10px' color='white' height='100%'>
          ...
          <Box className='buttonClassHomePage' display='flex' gap='20px' justifyContent='center'>
      ...
      <img className='meetingImage' src={Meeting} width='40%' style={{margin:'auto',display:'block',marginTop:'5%'}} />
    </Box>
  )
}
